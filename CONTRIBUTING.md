...
This outlines how to propose a change to paquetedepruebas1. For a
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("Martin-ia-pro/paquetedepruebas1", fork = TRUE)`.
...
[Contributor Code of
Conduct](https://martin-ia-pro.github.io/paquetedepruebas1/CODE_OF_CONDUCT.md).
